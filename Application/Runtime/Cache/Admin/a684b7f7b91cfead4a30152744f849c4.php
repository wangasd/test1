...
<div class="content">
    ...
    <div class="well">
    <a class="btn btn-primary" onclick="javascript:window.location.href='auth_add.html'">新增</a>
        <!-- table -->
        <table class="table table-bordered table-hover table-condensed">
            ...
            <?php if(is_array($data)): $k = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$a): $mod = ($k % 2 );++$k;?><tr class="success">
                    <td><?php echo ($a["id"]); ?></td>
                    <td><?php echo (str_repeat('&emsp;',$a["level"]*2)); echo ($a["auth_name"]); ?></td>
                    <td><?php echo ($a["pid"]); ?></td>
                    <td><?php echo ($a["auth_c"]); ?></td>
                    <td><?php echo ($a["auth_a"]); ?></td>
                    <td><?php if($a["is_nav"] == 1 ): ?>是<?php endif; ?></td>
                    <td><a href="auth_edit/id/<?php echo ($a["id"]); ?>" class="tablelink">编辑</a> <a href="auth_del/<?php echo ($a["id"]); ?>" class="tablelink"> 删除</a></td>
