...
<div class="content">
    ...
    <div class="well">
        ...
        <form id="tab" action="" method="post">
            ...
            <?php if(is_array($top)): $key = 0; $__LIST__ = $top;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($key % 2 );++$key;?><option value="<?php echo ($vol["id"]); ?>"><?php echo ($vol["auth_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
