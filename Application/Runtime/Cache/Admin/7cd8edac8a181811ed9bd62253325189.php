...
<link rel="stylesheet" type="text/css" href="/Public/Admin/bootstrap-responsive.min.css">
</head>
<body>
<!-- 上 -->
...
<div class="content">
    ...
    <div class="well">
    <a class="btn btn-primary" onclick="javascript:window.location.href='role_add.html'">新增</a>
        <!-- table -->
        <table class="table table-bordered table-hover table-condensed">
            ...
            <tbody>
            <?php if(is_array($group)): $k = 0; $__LIST__ = $group;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$g): $mod = ($k % 2 );++$k;?><tr class="success">
                <td><?php echo ($g["role_id"]); ?></td>
                <td><?php echo ($g["role_name"]); ?></td>
                <td><?php echo ($g["role_auth_ids"]); ?></td>
                <td><?php echo ($g["role_auth_ac"]); ?></td>
                <td>
                    <a href="/index.php/Admin/Role/setauth/id/<?php echo ($g["role_id"]); ?>">分派权限</a>
